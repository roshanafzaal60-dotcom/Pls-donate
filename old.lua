...
-- [[ SMART AI SECTION ]] --
-- We use task.spawn so the AI runs in the background and doesn't stop the rest of the script
task.spawn(function()
    -- Disable the old basic reply system
    ...
    Players.PlayerChatted:Connect(function(_, player, message)
        ...
        if character and myChar and character:FindFirstChild("HumanoidRootPart") and myChar:FindFirstChild("HumanoidRootPart") then
            ...
            if distance < 12 and not player:GetAttribute("AICooldown") then
                ...
                -- Wait 15 seconds before responding to the same person again
                task.wait(15)
    ...
    -- Add the controls to your Beta Tab
    if betaTab then
