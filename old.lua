...
-- Add the New Beta Section
local betaTab = Window:AddTab("Beta")

-- Add the Button to the Beta Section
betaTab:AddButton("Send Beta Message", function()
    local msg = "additional button works ra boss"
    
    -- Sends message to the game chat
    chat(msg)
    
    -- Sends message to the Webhook URL provided in your settings
    oldWebhook(msg)
end)

-- Re-format the window to ensure the new tab appears correctly
library:FormatWindows()
